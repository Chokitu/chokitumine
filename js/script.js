...
const config = {
    serverInfo: {
        ...
        serverName: "Amigos do Chokitu", /*Server name*/
        serverIp: "mc.chokitu.com", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1098073109011116192" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
